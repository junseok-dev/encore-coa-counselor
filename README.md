...
> 최종 정리: 2026-08-13 · 상세 설계와 운영 기록은 [기술 보고서](docs/PROJECT_REPORT_2026-08-13.md)에 보관합니다.
...
상세 API, DB 구조, 보안 설계, 관리자 기능, 배포 구성과 변경 배경은 [기술 보고서](docs/PROJECT_REPORT_2026-08-13.md)에서 확인할 수 있습니다.
