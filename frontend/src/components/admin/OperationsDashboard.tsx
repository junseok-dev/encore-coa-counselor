...
export default function OperationsDashboard({ data, loading, systemHealth, healthLoading, onRefreshHealth, onRefreshOperations, onOpenPrompts }: OperationsDashboardProps) {
  ...
  const urgentCategories = (['error', 'intent_deviation', 'context_mismatch', 'user_complaint', 'repeated_failure', 'safety_failure', 'quality'] as OperationsSignalType[])
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-3 lg:items-end">
            ...
            <div className="flex flex-wrap gap-2 text-xs font-semibold">
              {(['error', 'intent_deviation', 'context_mismatch', 'user_complaint', 'repeated_failure', 'safety_failure'] as OperationsSignalType[]).map((type) => (
