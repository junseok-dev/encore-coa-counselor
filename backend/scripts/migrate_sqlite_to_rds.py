...
TABLE_MODEL_MAP = [
    ...
    ("course_link_events", models.CourseLinkEvent),
    ("handoff_click_events", models.HandoffClickEvent),
...
DATETIME_COLUMNS = {
    ...
    "handoff_click_events": {"created_at"},
...
INTEGER_COLUMNS = {
    ...
    "cancel_requests": {"id"},
    "course_link_events": {"id"},
    "handoff_click_events": {"id"},
