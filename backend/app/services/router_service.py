...
- "out_of_scope": 교육과 무관(날씨·일반상식·코드 자문 등). 법률(정의·해석·적용)도 여기 — 법 내용 자체는 안내하지 않음. 단, 취업·취업연계·취업지원, 수료 후 진로·진출, 과정·커리큘럼·비용·혜택·선발·인터뷰, **나이 제한·지원 자격·연령·비전공 가능 여부**처럼 엔코아 AI 캠퍼스 교육·진로와 조금이라도 관련된 질문은 절대 out_of_scope가 아니다(faq 또는 rag로). "실버타운/나이 많은데/45세인데 가능?" 같이 개인 상황 단어가 섞여 있어도 핵심이 '지원 가능 여부·나이 제한'이면 절대 out_of_scope가 아니다.
...
_IN_DOMAIN_SIGNALS = (
    ...
    "나이", "연령", "지원", "자격", "비전공", "전공", "신청", "입과", "환불", "교육생",
)
