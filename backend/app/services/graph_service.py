...
VERIFY_PROMPT = (
    ...
    "승인 문서를 기본 근거로 사용하되, [공식 홈페이지 최신 정보]와 같은 항목이 "
    "충돌하면 공식 홈페이지 최신 정보를 우선하세요.\n"
    "문서에 없는 내용이나 사실과 다른 내용이 있으면 수정하세요.\n"
    "특정 기업의 검증된 채용 연계·취업 사례가 문서에 없으면 취업 가능성을 암시하는 표현을 삭제하되, "
    "정보나 사례가 없다고 답변해 취업 성과가 낮다는 인상도 주지 마세요.\n"
    "일반적인 취업 지원 프로그램을 특정 기업의 추천·연계·합격 가능성으로 확대 해석하지 마세요.\n"
    "문제가 없으면 그대로 반환하세요.\n"
