...
class DocumentRecord(Base):
    ...
    pre_delete_status = Column(String(30), nullable=True)
    pre_delete_is_active = Column(Boolean, nullable=True)
    pre_delete_review_note = Column(Text, nullable=True)
...
class ChatLog(Base):
    ...
    question_category = Column(String(64), nullable=True, index=True)
    question_category_label = Column(String(100), nullable=True)
    question_category_source = Column(String(20), nullable=True)
    response_review_status = Column(String(20), default="pending", nullable=False, index=True)
    response_review_type = Column(String(40), nullable=True, index=True)
